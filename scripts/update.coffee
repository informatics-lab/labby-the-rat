...
module.exports = (robot) ->
    ...
    msg_pending = "I have some pending updates, RELOAD ME PLEASE! (hint: labby reload all scripts)"
    msg_downoaded = "I downloaded some updates, RELOAD ME PLEASE! (hint: labby reload all scripts)"

    robot.respond /pending updates?\??$/i, (msg) ->
        if downloaded_updates
            msg.send msg_pending
        else
